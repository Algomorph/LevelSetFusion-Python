  ...
  if(NOT ${found})
    ...
    if(PYTHONINTERP_FOUND)
      ...
      if(NOT "${_python_version_major}" STREQUAL "${PYTHON_VERSION_MAJOR}"
        ...
        clear_vars(PYTHONINTERP_FOUND PYTHON_EXECUTABLE PYTHON_VERSION_STRING PYTHON_VERSION_MAJOR PYTHON_VERSION_MINOR PYTHON_VERSION_PATCH)
    ...
    if(_found)
      ...
      if(NOT ANDROID AND NOT APPLE_FRAMEWORK)
        check_environment_variables(${library_env} ${include_dir_env})
